...
const routes = [{ path: 'productList', component: _product_product_component__WEBPACK_IMPORTED_MODULE_3__["ProductComponent"] },
];
...
let ProductComponent = class ProductComponent {
    ...
    ngOnInit() {
        this.httpClientService.getProducts().subscribe(response => this.handleSuccessfulResponse(response));
    }
...
class Product {
    constructor(productId, name, code, title, description, imgUrl, price) {
...
module.exports = __webpack_require__(/*! /home/faiz/ubuntu_18.04_workspace/Spring_WorkArea/Project_WorkArea/SpringRestServices/ProductApp/ProductUI/src/main.ts */"./src/main.ts");
